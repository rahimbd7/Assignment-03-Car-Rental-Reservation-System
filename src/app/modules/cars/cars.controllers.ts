...
const createACar = catchAsync(async (req, res, next) => {
    ...
    if (result) {
        sendResponse(res, { statusCode: httpStatus.CREATED, success: true, message: 'Car created successfully', data: result })
    }else{
        throw new Error()
    }
})
...
const getAllCars = catchAsync(async (req, res, next) => {
    ...
    if (result) {
        sendResponse(res, { statusCode: httpStatus.OK, success: true, message: 'Cars retrieved successfully', data: result })
    }else{
        throw new Error()
    }
})
...
const getACars = catchAsync(async (req, res, next) => {
    ...
    if (result) {
        sendResponse(res, { statusCode: httpStatus.OK, success: true, message: 'A car retrieved successfully', data: result })
    }else{
        throw new Error()
    }
})
...
const updateACar = catchAsync(async (req, res, next) => {
    ...
    if (result) {
        sendResponse(res, { statusCode: httpStatus.OK, success: true, message: 'Car updated successfully', data: result })
    }else{
        throw new Error()
    }
})
...
const deleteACar = catchAsync(async (req, res, next) => {
    ...
    if (result) {
        sendResponse(res, { statusCode: httpStatus.OK, success: true, message: 'Car deleted successfully', data: result })
    }else{
        throw new Error();
    }
})
